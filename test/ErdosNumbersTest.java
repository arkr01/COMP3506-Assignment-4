...
public class ErdosNumbersTest {
    ...
    public void basicTest() {
        ...
        assertEquals(Set.of("Vertex‐distinguishing edge colorings of graphs", "Adjacent vertex distinguishing edge-colorings"),
                nums.getPapers("Balister, P. N."));
        assertEquals(Set.of("Riordan, O. M.", "Gyori, E.", "Lehel, J.", "Schelp, R. H."),
                nums.getCollaborators("Balister, P. N."));
    }
    ...
    public void uqTest() {
        List<String> papers = List.of(
                ...
                "A Database Index to Large Biological Sequences:Ela Hunt|Malcolm P" +
                        ". Atkinson|Robert W. Irving",
        ...
        assertEquals(3.5, nums.calculateWeightedErdosNumber("Richard Thomas"), 0.001);
